      ...
      case 'stickers':
        return (
          <svg width={size} height={size} viewBox="0 0 40 40" fill="none" className="inline-block">
            ...
            <circle cx="14" cy="14" r="7" fill="#E8C568" fillOpacity="0.5" stroke="#C9A840" strokeWidth="1.5" filter="url(#icon-pencil-sticker)"/>
            <circle cx="27" cy="13" r="5" fill="#E89BA8" fillOpacity="0.5" stroke="#C97080" strokeWidth="1.5" filter="url(#icon-pencil-sticker)"/>
            <circle cx="20" cy="27" r="6" fill="#9BC9A5" fillOpacity="0.5" stroke="#6BA880" strokeWidth="1.5" filter="url(#icon-pencil-sticker)"/>
          </svg>
        );
      case 'stars':
        return (
          <svg width={size} height={size} viewBox="0 0 40 40" fill="none" className="inline-block">
            ...
            <path d="M20 5 L22 15 L32 15 L24 22 L27 32 L20 26 L13 32 L16 22 L8 15 L18 15 Z"
                  ...
                  filter="url(#icon-pencil-stars)" strokeLinejoin="round"/>
