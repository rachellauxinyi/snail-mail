        ...
        <div className="fixed inset-0 bg-[#F7F4F0] flex flex-col items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center gap-5 text-center px-8 max-w-md">
            ...
            <svg width="110" height="90" viewBox="0 0 110 90" fill="none">
              ...
              <rect x="26" y="22" width="38" height="46" rx="1" fill="#FEFDFB" stroke="#A89478" strokeWidth="1.2"/>
              <line x1="32" y1="30" x2="58" y2="30" stroke="#C4BAB0" strokeWidth="1" strokeLinecap="round"/>
              <line x1="32" y1="36" x2="58" y2="36" stroke="#C4BAB0" strokeWidth="1" strokeLinecap="round"/>
              <line x1="32" y1="42" x2="50" y2="42" stroke="#C4BAB0" strokeWidth="1" strokeLinecap="round"/>
      ...
      <div className="fixed inset-0 bg-[#F7F4F0] flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-5 text-center px-8 max-w-md">
          ...
          <svg width="130" height="96" viewBox="0 0 130 96" fill="none">
            ...
            <rect x="32" y="16" width="42" height="54" rx="1" fill="#FEFDFB" stroke="#A89478" strokeWidth="1.2"/>
            <line x1="38" y1="25" x2="68" y2="25" stroke="#C4BAB0" strokeWidth="1" strokeLinecap="round"/>
            <line x1="38" y1="32" x2="68" y2="32" stroke="#C4BAB0" strokeWidth="1" strokeLinecap="round"/>
            <line x1="38" y1="39" x2="60" y2="39" stroke="#C4BAB0" strokeWidth="1" strokeLinecap="round"/>
